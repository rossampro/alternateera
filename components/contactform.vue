    ...
    <div class="card bg-base-300">
        <div id="mc_embed_shell">
            <div id="mc_embed_signup">
                <form
                    action="https://gmail.us20.list-manage.com/subscribe/post?u=9848c570f48b92b911e6a7195&amp;id=0578cfc38c&amp;f_id=00b359eef0"
                    method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate"
                    target="_self" novalidate="false">
                    <div id="mc_embed_signup_scroll" class="prose">
                        <h2>Subscribe</h2>
                        <div class="indicates-required"><span class="asterisk">*</span> indicates required</div>
                        <div class="mc-field-group"><label for="mce-EMAIL">Email Address <span
                                    class="asterisk">*</span></label><input type="email" name="EMAIL"
                                class="required email input" id="mce-EMAIL" required="true" value=""></div>
                        <div class="mc-field-group"><label for="mce-FNAME">First Name <span
                                    class="asterisk">*</span></label><input type="text" name="FNAME"
                                class="required text input" id="mce-FNAME" required="true" value=""></div>
                        <div class="mc-field-group"><label for="mce-LNAME">Last Name <span
                                    class="asterisk">*</span></label><input type="text" name="LNAME"
                                class="required text input" id="mce-LNAME" required="true" value=""></div>
                        <div id="mergeRow-gdpr" class="mergeRow gdpr-mergeRow content__gdprBlock mc-field-group">
                            <div class="content__gdpr"><label>Marketing Permissions</label>
                                <p>Please select all the ways you would like to hear from Alternate Era:</p>
                                <fieldset class="mc_fieldset gdprRequired mc-field-group" name="interestgroup_field">
                                    <label class="subfield" for="gdpr38151"><input type="checkbox" id="gdpr_38151"
                                            name="gdpr[38151]" class="gdpr" value="Y"><span>Email</span></label>
                                </fieldset>
                        ...
                        <div hidden=""><input type="hidden" name="tags" value="4275206"></div>
                        ...
                        <div aria-hidden="true" style="position: absolute; left: -5000px;">
                            ...
                            form
                            bot signups */
                            <input type="text" name="b_9848c570f48b92b911e6a7195_0578cfc38c" tabindex="-1" value="">
                        </div>
                        <div class="optionalParent">
                            <div class="clear foot">
                                <input type="submit" name="subscribe" id="mc-embedded-subscribe" class="button btn"
                                    value="Subscribe">
                                <p style="margin: 0px auto;"><a href="http://eepurl.com/i8fD3M"
